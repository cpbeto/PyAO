...
def load():
    with open(GRH_PATH, 'rb') as f:
        ...
        grh_data = {} # Workaround VB6 1-based indexes, also allows random access

        try:
            for i in range(grh_count):
                ...
                grh = {}
                grh['frames'] = {} # Workaround VB6 1-based indexes
